...
axes[3,1].text(10,150,'mean(2012-2014)',fontsize=15)

axes[0,0].text(0,100,'r^2=%s'%str(np.corrcoef(windu2012,numu2012)[0][1]))
axes[0,1].text(20,50,'r^2=%s'%str(np.corrcoef(-np.array(windv2012),numv2012)[0][1]))
axes[1,0].text(20,80,'r^2=%s'%str(np.corrcoef(windu2013,numu2013)[0][1]))
axes[1,1].text(20,20,'r^2=%s'%str(np.corrcoef(-np.array(windv2013),numv2013)[0][1]))

axes[2,0].text(20,80,'r^2=%s'%str(np.corrcoef(windu2014,numu2014)[0][1]))
axes[2,1].text(20,50,'r^2=%s'%str(np.corrcoef(-np.array(windv2014),numv2014)[0][1]))
...
axes[0,0].set_title('strandings vs eastward wind stress')#Eastward wind stress vs strandings on Outer Cape towns')
axes[0,1].set_title('strandings vs northward wind stress')#'Northward wind stress vs strandings on Mid Cape towns')
'''
...
axes[3,1].text(20,50,'r^2=%s'%str(np.corrcoef(-np.array(wv),nv)[0][1]))
...
'''
plt.savefig('corrxxmx_xin',dpi=300)
